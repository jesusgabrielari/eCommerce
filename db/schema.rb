...
ActiveRecord::Schema.define(version: 2021_10_09_143738) do
  ...
  create_table "client_discounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["coupon_id"], name: "index_client_discounts_on_coupon_id"
    t.index ["user_id"], name: "index_client_discounts_on_user_id"
  end
  ...
  add_foreign_key "client_discounts", "coupons"
  add_foreign_key "client_discounts", "users"
